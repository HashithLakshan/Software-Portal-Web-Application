...
import Software.Portal.web.mpping.CategoryMapping;
    ...
    public CommonResponse save(CategoryDto categoryDto) {
        ...
        try {
            ...
            if (CommonValidation.stringNullValidation(categoryDto.getCategoryId())) {
                ...
                categoryDto.setSaveDate(String.valueOf(today));
                categoryDto.setCategoryId("22");
...
//                category.setCommonStatus(categoryDto.getCommonStatus());
                Category Createcategory = categoryMapping.toCategory(categoryDto);
